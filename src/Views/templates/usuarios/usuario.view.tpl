...
<section class="container-m row px-4 py-4">
    ...
    <form action="index.php?page=Usuarios_Usuario&mode={{~mode}}" method="POST" class="col-12 col-m-8 offset-m-2">
        ...
        <div class="row my-2 align-center">
            ...
            <input class="col-12 col-m-9" type="password" name="userpswd" value="{{userpswd}}" {{readonly}}>
        ...
        <div class="row my-2 align-center">
            ...
            <select class="col-12 col-m-9" name="userest" {{if readonly}}disabled{{endif readonly}}>
