...
<section class="container-m row px-4 py-4">
  {{with product}}
  <form action="index.php?page=Products_Product&mode={{~mode}}&productId={{productId}}" 
        method="POST" 
        class="col-12 col-m-8 offset-m-2 form-product">
    ...
    <div class="form-group">
      ...
      <input {{~readonly}} type="text" name="productName" id="productName" 
    ...
    <div class="form-group">
      ...
      <textarea {{~readonly}} name="productDescription" id="productDescription" 
    ...
    <div class="form-group">
      ...
      <input {{~readonly}} type="number" name="productStock" id="productStock" 
             placeholder="Cantidad en inventario" value="{{productStock}}" />
    ...
    <div class="form-group">
      ...
      <input {{~readonly}} type="text" name="productImgUrl" id="productImgUrl" 
